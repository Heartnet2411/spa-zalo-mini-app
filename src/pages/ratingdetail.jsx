          ...
          <div className="bg-gray-50 rounded-lg border w-full mb-5">
            <div className="border-b-2">
              <div className="flex items-center">
                <span className="text-base ml-2">Chất lượng sản phẩm:</span>
                <textarea
              ...
              <div className="flex items-center">
                <span className="text-base ml-2">Đúng với mô tả:</span>
                <textarea
                  className="m-2 bg-gray-50 resize-none"
                  rows={1}
                ></textarea>
            ...
            <textarea
              className="mt-2 ml-2 bg-gray-50 resize-none w-full"
