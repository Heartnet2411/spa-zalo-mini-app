...
// import React, { useState, useEffect } from 'react';
// import { Button, Page } from 'zmp-ui';
// import { suggestProductsForUser } from '../services/recommendersystem.service';
...
//     // Giả định userId có sẵn, bạn có thể thay đổi thành giá trị thực tế
//     const userId = 'user123'; 

//     // Gọi API để lấy danh sách sản phẩm gợi ý
//     const fetchSuggestedServices = async () => {
//       try {
//         const suggestedServices = await suggestProductsForUser(userId);
//         setServices(suggestedServices); // Cập nhật danh sách dịch vụ
//       } catch (error) {
//         console.error('Error fetching suggested services:', error);
//       }
//     };

//     fetchSuggestedServices(); // Gọi hàm lấy dữ liệu khi component được render
//   }, []);
...
//                 ))
//               ) : (
//                 <p>Đang tải danh sách dịch vụ...</p> // Hiển thị nếu chưa có dữ liệu
//               )}
//             </div>
